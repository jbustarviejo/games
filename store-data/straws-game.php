...
$sql = "INSERT INTO strawsGameRecords (`id_user`, `time`, `selected`, `winner`, `straws_number`) VALUES ('" . $_POST["userId"] . "', '" . $_POST["time"] . "', '" . $_POST["selected"] . "', '" . $_POST["winner"] . "', '" . $_POST["strawsNumber"] . "')";
