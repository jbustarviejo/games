...
registerInStrawsGameRecords($conn);
...
/**
* Función registerInStrawsGameRecords: Registrar lo ocurrido en el juego
* @param $conn | Conexión a BD
* @returns NULL | No devuelve ningún valor
*/
function registerInStrawsGameRecords($conn){
...
function registerInHistory($conn, $points_variation, $points_result){
	$sql = "INSERT INTO gamesHistory(`id_user`, `date`, `game`, `time_to_choose`, `points_variation`, `points_result`) VALUES ('" . $_POST["userId"] . "', '" . date('Y-m-d H:i:s') . "', 'strawsGame', NULL, '" . $points_variation . "', '" . $points_result .  "')";
